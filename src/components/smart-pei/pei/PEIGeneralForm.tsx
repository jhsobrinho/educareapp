...
const PEIGeneralForm: React.FC<PEIGeneralFormProps> = ({
  ...
  const { generateTitleSuggestions, generateSummarySuggestions } = usePEIAIAssistance();
        ...
        <div>
          ...
          <div className="space-y-5">
            <div className="space-y-2">
              ...
              <AIAssistSuggestion
                title="título"
                onRequestSuggestion={generateTitleSuggestions}
                onAccept={(suggestion) => setTitle(suggestion as string)}
                type="text"
                context={`Com base no perfil do aluno ${studentName} e suas necessidades`}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <AIAssistSuggestion
                title="resumo"
                onRequestSuggestion={generateSummarySuggestions}
                onAccept={(suggestion) => setNotes(suggestion as string)}
                type="text"
                context={`Um resumo conciso dos objetivos e focos do PEI para ${studentName}`}
              />
            </div>
          </div>
        </div>
